!function() {
    ...
    function A(e) {
        var t = f({
          ...
          , n = S || [].slice.call(document.getElementsByTagName("script")).filter(function(e) {
        ...
        return !0 === t.loadSidebar && (t.loadSidebar = "_sidebar" + t.ext),
    ...
    var De = xe(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content", "data", "datalist", "dd", "decorator", "del", "details", "dfn", "dir", "div", "dl", "dt", "element", "em", "fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "section", "select", "shadow", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"])
      , je = xe(["svg", "a", "altglyph", "altglyphdef", "altglyphitem", "animatecolor", "animatemotion", "animatetransform", "audio", "canvas", "circle", "clippath", "defs", "desc", "ellipse", "filter", "font", "g", "glyph", "glyphref", "hkern", "image", "line", "lineargradient", "marker", "mask", "metadata", "mpath", "path", "pattern", "polygon", "polyline", "radialgradient", "rect", "stop", "style", "switch", "symbol", "text", "textpath", "title", "tref", "tspan", "video", "view", "vkern"])
      ...
      , Ie = xe(["math", "menclose", "merror", "mfenced", "mfrac", "mglyph", "mi", "mlabeledtr", "mmultiscripts", "mn", "mo", "mover", "mpadded", "mphantom", "mroot", "mrow", "ms", "mspace", "msqrt", "mstyle", "msub", "msup", "msubsup", "mtable", "mtd", "mtext", "mtr", "munder", "munderover"])
      , qe = xe(["#text"])
      ...
      , Ve = $(/^data-[\-\w.\u00B7-\uFFFF]/)
      , Xe = $(/^aria-[\-\w]+$/)
      , Ke = $(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i)
      , Qe = $(/^(?:\w+script|data):/i)
      , Je = $(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205f\u3000]/g)
    ...
    var nt = function() {
      ...
      , rt = function(e, t) {
        if ("object" !== (void 0 === e ? "undefined" : et(e)) || "function" != typeof e.createPolicy)
            return null;
        var n = null
    ...
    var P, D, j = function t(e) {
        ...
        function L(e) {
            pe && pe === e || (e && "object" === (void 0 === e ? "undefined" : et(e)) || (e = {}),
            j = "ALLOWED_TAGS"in e ? Ne({}, e.ALLOWED_TAGS) : H,
            I = "ALLOWED_ATTR"in e ? Ne({}, e.ALLOWED_ATTR) : q,
            ce = "ADD_URI_SAFE_ATTR"in e ? Ne(Pe(ue), e.ADD_URI_SAFE_ATTR) : ue,
            ...
            Ne(I, Be),
            Ne(I, We)),
            !0 === oe.svgFilters && (Ne(j, He),
            Ne(I, Be),
            Ne(I, We)),
            !0 === oe.mathMl && (Ne(j, Ie),
            Ne(I, Ze),
            Ne(I, We))),
            e.ADD_TAGS && (j === H && (j = Pe(j)),
            Ne(j, e.ADD_TAGS)),
            e.ADD_ATTR && (I === q && (I = Pe(I)),
            Ne(I, e.ADD_ATTR)),
        ...
        var F = Ye
          ...
          , ae = !1
          , oe = {}
          , se = Ne({}, ["annotation-xml", "audio", "colgroup", "desc", "foreignobject", "head", "iframe", "math", "mi", "mn", "mo", "ms", "mtext", "noembed", "noframes", "plaintext", "script", "style", "svg", "template", "thead", "title", "video", "xmp"])
          , le = Ne({}, ["audio", "video", "img", "source", "image"])
          , ce = null
          , ue = Ne({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "summary", "title", "value", "style", "xmlns"])
          , pe = null
          , de = l.createElement("form");
        d.isSupported && (function() {
            try {
                $('<svg><p><textarea><img src="</textarea><img src=x abc=1//">').querySelector("svg img") && (o = !0)
            } catch (e) {}
        }(),
        function() {
            try {
        ...
        function he(e) {
            return "object" === (void 0 === f ? "undefined" : et(f)) ? e instanceof f : e && "object" === (void 0 === e ? "undefined" : et(e)) && "number" == typeof e.nodeType && "string" == typeof e.nodeName
        }
        function ge(e, t, n) {
        ...
        function me(e) {
            var t = void 0;
            if (ge("beforeSanitizeElements", e, null),
            function(e) {
                return !(e instanceof h || e instanceof g || "string" == typeof e.nodeName && "string" == typeof e.textContent && "function" == typeof e.removeChild && e.attributes instanceof a && "function" == typeof e.removeAttribute && "function" == typeof e.setAttribute && "string" == typeof e.namespaceURI)
            }(e))
                return R(e),
                !0;
            var n = Le(e.nodeName);
            ...
            ("svg" === n || "math" === n) && 0 !== e.querySelectorAll("p, br").length)
                return R(e),
                !0;
            if (j[n] && !U[n])
                return "noscript" === n && ze(/<\/noscript/i, e.innerHTML) ? (R(e),
                !0) : "noembed" === n && ze(/<\/noembed/i, e.innerHTML) ? (R(e),
                !0) : (!G || e.firstElementChild || e.content && e.content.firstElementChild || !ze(/</g, e.textContent) || (Te(d.removed, {
                    element: e.cloneNode()
                }),
                e.innerHTML ? e.innerHTML = Ce(e.innerHTML, /</g, "&lt;") : e.innerHTML = Ce(e.textContent, /</g, "&lt;")),
                V && 3 === e.nodeType && (t = e.textContent,
                t = Ce(t, F, " "),
                t = Ce(t, z, " "),
                e.textContent !== t && (Te(d.removed, {
                    element: e.cloneNode()
                }),
                e.textContent = t)),
        ...
        function ve(e, t, n) {
            ...
            if (W && ze(O, t))
                ...
                if (ce[t])
                    ...
                    ;
                else if ("src" !== t && "xlink:href" !== t && "href" !== t || "script" === e || 0 !== $e(n, "data:") || !le[e])
                    if (Y && !ze(N, Ce(n, P, "")))
                        ;
                    else if (n)
                        return !1
                ...
                for (a = o.length; a--; ) {
                    ...
                    !s.forceKeepAttr) {
                        if ("name" === r && "IMG" === e.nodeName && o.id)
                            ...
                            if ("INPUT" === e.nodeName && "type" === r && "file" === n && s.keepAttr && (I[r] || !B[r]))
                                continue;
                            "id" === c && e.setAttribute(c, ""),
                            C(c, e)
                        }
                        if (s.keepAttr)
                            if (G && ze(/\/>/i, n))
                                C(c, e);
                            else if (ze(/svg|math/i, e.namespaceURI) && ze(Oe("</(" + Se(ke(se), "|") + ")", "i"), n))
                                C(c, e);
                            else {
                                V && (n = Ce(n, F, " "),
                                n = Ce(n, z, " "));
        ...
        function ye(e) {
            ...
            for (ge("beforeSanitizeShadowDOM", e, null); t = n.nextNode(); )
                ...
                me(t) || (t.content instanceof p && ye(t.content),
                be(t));
        ...
        return d.sanitize = function(e, t) {
            ...
            if (K || L(t),
            d.removed = [],
            "string" == typeof e && (ae = !1),
            ae)
                ;
            else if (e instanceof f)
                1 === (r = (n = $("\x3c!--\x3e")).ownerDocument.importNode(e, !0)).nodeType && "BODY" === r.nodeName ? n = r : "HTML" === r.nodeName ? n = r : n.appendChild(r);
            else {
            ...
            for (var s = fe(ae ? e : n); i = s.nextNode(); )
                3 === i.nodeType && i === a || me(i) || (i.content instanceof p && ye(i.content),
                be(i),
                a = i);
            if (a = null,
            ae)
    ...
    function H(e) {
        ...
        t = i ? 80 < (t = parseInt(P.style.width || 0, 10) + i) ? 80 : t : Math.floor(n / r * 100),
        P.style.opacity = 1,
    ...
    function Y(e, t, r, n) {
        ...
        return i.sort(function(e, t) {
            ...
            var t = e.getAttribute("href")
              , n = r ? e.parentNode : e;
            e.title = e.innerText,
            0 !== o.indexOf(t) || a ? _(n, "remove", "active") : (a = e,
            _(n, "add", "active"))
        }),
    ...
    function K(e, t) {
        ...
        var n = [];
        for (var r in e)
            -1 < t.indexOf(r) || n.push(e[r] ? (V(r) + "=" + V(e[r])).toLowerCase() : V(r));
    ...
    function me(e) {
        if (he) {
            for (var t, n = m(".sidebar"), r = y(".anchor"), i = b(n, ".sidebar-nav"), a = b(n, "li.active"), o = document.documentElement, s = (o && o.scrollTop || document.body.scrollTop) - ge, l = 0, c = r.length; l < c; l += 1) {
                var u = r[l];
                if (u.offsetTop > s) {
                    t = t || u;
                    break
            ...
            if (t) {
                ...
                if (p && p !== a && (a && a.classList.remove("active"),
    ...
    var bt = {}
      ...
      , xt = /^([^:]+:\/*[^/]*)[\s\S]*$/;
    function wt(e, t) {
        bt[" " + e] || (yt.test(e) ? bt[" " + e] = e + "/" : bt[" " + e] = _t(e, "/", !0));
        var n = -1 === (e = bt[" " + e]).indexOf(":");
        return "//" === t.substring(0, 2) ? n ? t : e.replace(kt, "$1") + t : "/" === t.charAt(0) ? n ? t : e.replace(xt, "$1") + t : e + t
    }
    function _t(e, t, n) {
        var r = e.length;
        if (0 === r)
    ...
    var St = function(e, t) {
        if (t) {
            if (lt.test(e))
                return e.replace(ct, ot)
        } else if (ut.test(e))
            return e.replace(pt, ot);
        return e
    }
      , At = ht
      , Tt = function(n, e) {
        ...
        var r = {
            replace: function(e, t) {
                return t = (t = t.source || t).replace(gt, "$1"),
                n = n.replace(e, t),
                r
            },
            getRegex: function() {
      ...
      , Et = function(e, t, n) {
        if (e) {
            var r;
            try {
                r = decodeURIComponent(ht(n)).replace(mt, "").toLowerCase()
            } catch (e) {
                return null
            }
    ...
    var Ht = function() {
        ...
        e.prototype.list = function(e) {
            ...
            if (t) {
                for (var n, r, i, a, o, s, l, c = t[0], u = t[2], p = 1 < u.length, d = ")" === u[u.length - 1], f = {
                    type: "list",
                    raw: c,
                    ordered: p,
                    start: p ? +u.slice(0, -1) : "",
                    loose: !1,
                    items: []
                }, h = t[0].match(this.rules.block.item), g = !1, m = h.length, v = 0; v < m; v++)
                    r = (c = n = h[v]).length,
                    ~(n = n.replace(/^ *([*+-]|\d+[.)]) */, "")).indexOf("\n ") && (r -= n.length,
                    n = this.options.pedantic ? n.replace(/^ {1,4}/gm, "") : n.replace(new RegExp("^ {1," + r + "}","gm"), "")),
                    v !== m - 1 && (i = this.rules.block.bullet.exec(h[v + 1])[0],
                    (p ? 1 === i.length || !d && ")" === i[i.length - 1] : 1 < i.length || this.options.smartLists && i !== u) && (a = h.slice(v + 1).join("\n"),
        ...
        e.prototype.html = function(e) {
            ...
            if (t)
                return {
                    ...
                    text: this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(t[0]) : Pt(t[0]) : t[0]
                }
        }
        ,
        ...
        e.prototype.table = function(e) {
            ...
            if (t) {
                ...
                if (n.header.length === n.align.length) {
                    ...
                    for (i = n.cells.length,
                    r = 0; r < i; r++)
                        n.cells[r] = Nt(n.cells[r].replace(/^ *\| *| *\| *$/g, ""), n.header.length);
                    return n
                }
            }
        }
        ...
        e.prototype.tag = function(e, t, n) {
            ...
            if (r)
                ...
                !n && /^<(pre|code|kbd|script)(\s|>)/i.test(r[0]) ? n = !0 : n && /^<\/(pre|code|kbd|script)(\s|>)/i.test(r[0]) && (n = !1),
                {
                    ...
                    inLink: t,
                    inRawBlock: n,
                    text: this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(r[0]) : Pt(r[0]) : r[0]
                }
        }
        ,
        ...
        e.prototype.autolink = function(e, t) {
            ...
            if (i)
                return r = "@" === i[2] ? "mailto:" + (n = Pt(this.options.mangle ? t(i[1]) : i[1])) : n = Pt(i[1]),
                {
                    type: "link",
                    raw: i[0],
                    text: n,
        ...
        e.prototype.inlineText = function(e, t, n) {
            ...
            if (i)
                return r = t ? this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(i[0]) : Pt(i[0]) : i[0] : Pt(this.options.smartypants ? n(i[0]) : i[0]),
                {
                    type: "text",
                    raw: i[0],
                    text: r
    ...
    Bt.def = qt(Bt.def).replace("label", Bt._label).replace("title", Bt._title).getRegex(),
    Bt.bullet = /(?:[*+-]|\d{1,9}[.)])/,
    Bt.item = /^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/,
    Bt.item = qt(Bt.item, "gm").replace(/bull/g, Bt.bullet).getRegex(),
    Bt.list = qt(Bt.list).replace(/bull/g, Bt.bullet).replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def", "\\n+(?=" + Bt.def.source + ")").getRegex(),
    Bt._tag = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",
    Bt._comment = /<!--(?!-?>)[\s\S]*?-->/,
    Bt.html = qt(Bt.html, "i").replace("comment", Bt._comment).replace("tag", Bt._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),
    Bt.paragraph = qt(Bt._paragraph).replace("hr", Bt.hr).replace("heading", " {0,3}#{1,6} ").replace("|lheading", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|!--)").replace("tag", Bt._tag).getRegex(),
    Bt.blockquote = qt(Bt.blockquote).replace("paragraph", Bt.paragraph).getRegex(),
    Bt.normal = Ut({}, Bt),
    Bt.gfm = Ut({}, Bt.normal, {
    ...
    Bt.gfm.table = qt(Bt.gfm.table).replace("hr", Bt.hr).replace("heading", " {0,3}#{1,6} ").replace("blockquote", " {0,3}>").replace("code", " {4}[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|!--)").replace("tag", Bt._tag).getRegex(),
    ...
    Zt.punctuation = qt(Zt.punctuation).replace(/punctuation/g, Zt._punctuation).getRegex(),
    Zt._blockSkip = "\\[[^\\]]*?\\]\\([^\\)]*?\\)|`[^`]*?`|<[^>]*?>",
    Zt._overlapSkip = "__[^_]*?__|\\*\\*\\[^\\*\\]*?\\*\\*",
    Zt.em.start = qt(Zt.em.start).replace(/punctuation/g, Zt._punctuation).getRegex(),
    Zt.em.middle = qt(Zt.em.middle).replace(/punctuation/g, Zt._punctuation).replace(/overlapSkip/g, Zt._overlapSkip).getRegex(),
    Zt.em.endAst = qt(Zt.em.endAst, "g").replace(/punctuation/g, Zt._punctuation).getRegex(),
    Zt.em.endUnd = qt(Zt.em.endUnd, "g").replace(/punctuation/g, Zt._punctuation).getRegex(),
    Zt.strong.start = qt(Zt.strong.start).replace(/punctuation/g, Zt._punctuation).getRegex(),
    Zt.strong.middle = qt(Zt.strong.middle).replace(/punctuation/g, Zt._punctuation).replace(/blockSkip/g, Zt._blockSkip).getRegex(),
    Zt.strong.endAst = qt(Zt.strong.endAst, "g").replace(/punctuation/g, Zt._punctuation).getRegex(),
    Zt.strong.endUnd = qt(Zt.strong.endUnd, "g").replace(/punctuation/g, Zt._punctuation).getRegex(),
    ...
    Zt.autolink = qt(Zt.autolink).replace("scheme", Zt._scheme).replace("email", Zt._email).getRegex(),
    Zt._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/,
    Zt.tag = qt(Zt.tag).replace("comment", Bt._comment).replace("attribute", Zt._attribute).getRegex(),
    Zt._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,
    Zt._href = /<(?:\\[<>]?|[^\s<>\\])*>|[^\s\x00-\x1f]*/,
    Zt._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/,
    Zt.link = qt(Zt.link).replace("label", Zt._label).replace("href", Zt._href).replace("title", Zt._title).getRegex(),
    Zt.reflink = qt(Zt.reflink).replace("label", Zt._label).getRegex(),
    Zt.reflinkSearch = qt(Zt.reflinkSearch, "g").replace("reflink", Zt.reflink).replace("nolink", Zt.nolink).getRegex(),
    Zt.normal = Ut({}, Zt),
    Zt.pedantic = Ut({}, Zt.normal, {
        ...
        link: qt(/^!?\[(label)\]\((.*?)\)/).replace("label", Zt._label).getRegex(),
        reflink: qt(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", Zt._label).getRegex()
    }),
    Zt.gfm = Ut({}, Zt.normal, {
        escape: qt(Zt.escape).replace("])", "~|])").getRegex(),
    ...
    Zt.gfm.url = qt(Zt.gfm.url, "i").replace("email", Zt.gfm._extended_email).getRegex(),
    Zt.breaks = Ut({}, Zt.gfm, {
        br: qt(Zt.br).replace("{2,}", "*").getRegex(),
        text: qt(Zt.gfm.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex()
    });
    var Wt = {
        block: Bt,
        inline: Zt
    ...
    var Qt = function() {
        function n(e) {
            ...
            this.options.pedantic ? (t.block = Gt.pedantic,
            t.inline = Vt.pedantic) : this.options.gfm && (t.block = Gt.gfm,
        ...
        n.prototype.inline = function(e) {
            ...
            for (t = 0; t < s; t++)
                ...
                case "heading":
                    o.tokens = [],
                    this.inlineTokens(o.text, o.tokens);
                    break;
                case "table":
                    for (o.tokens = {
                        header: [],
        ...
        n.prototype.inlineTokens = function(e, t, n, r, i) {
            ...
            if (this.tokens.links) {
                ...
                if (0 < l.length)
                    for (; null != (o = this.tokenizer.rules.inline.reflinkSearch.exec(s)); )
            ...
            for (; e; )
                if (a = this.tokenizer.escape(e))
                    ...
                    e = e.substring(a.raw.length),
                    "link" === a.type && (a.tokens = this.inlineTokens(a.text, [], !0, r)),
                    t.push(a);
      ...
      , nn = function() {
        ...
        return e.prototype.code = function(e, t, n) {
            ...
            return r ? '<pre><code class="' + this.options.langPrefix + tn(r, !0) + '">' + (n ? e : tn(e, !0)) + "</code></pre>\n" : "<pre><code>" + (n ? e : tn(e, !0)) + "</code></pre>\n"
        }
        ,
        e.prototype.blockquote = function(e) {
            return "<blockquote>\n" + e + "</blockquote>\n"
      ...
      , ln = function() {
        ...
        n.prototype.parse = function(e, t) {
            void 0 === t && (t = !0);
            var n, r, i, a, o, s, l, c, u, p, d, f, h, g, m, v, b, y, k = "", x = e.length;
            for (n = 0; n < x; n++)
                switch ((p = e[n]).type) {
                case "space":
                    continue;
                case "hr":
                    ...
                    continue;
                case "heading":
                    k += this.renderer.heading(this.parseInline(p.tokens), p.depth, sn(this.parseInline(p.tokens, this.textRenderer)), this.slugger);
                    continue;
                case "code":
                ...
                case "table":
                    ...
                    a = p.header.length,
                    r = 0; r < a; r++)
                        l += this.renderer.tablecell(this.parseInline(p.tokens.header[r]), {
                            header: !0,
                            align: p.align[r]
                        });
                ...
                case "list":
                    ...
                    r = 0; r < a; r++)
                        ...
                        b = m.task,
                        g = "",
                        m.task && (y = this.renderer.checkbox(v),
                        h ? 0 < m.tokens.length && "text" === m.tokens[0].type ? (m.tokens[0].text = y + " " + m.tokens[0].text,
                        m.tokens[0].tokens && 0 < m.tokens[0].tokens.length && "text" === m.tokens[0].tokens[0].type && (m.tokens[0].tokens[0].text = y + " " + m.tokens[0].tokens[0].text)) : m.tokens.unshift({
                            type: "text",
                            text: y
                        }) : g += y),
                ...
                case "paragraph":
                    ...
                    continue;
                case "text":
                    for (u = p.tokens ? this.parseInline(p.tokens) : p.text; n + 1 < x && "text" === e[n + 1].type; )
    ...
    function gn(e, n, r) {
        ...
        r) {
            ...
            !i.length)
                return o();
            var s = 0;
            return gn.walkTokens(i, function(n) {
                "code" === n.type && (s++,
                setTimeout(function() {
                    a(n.text, n.lang, function(e, t) {
                        if (e)
                            return o(e);
                        null != t && t !== n.text && (n.text = t,
                        n.escaped = !0),
                        0 === --s && o()
                    })
                }, 0))
        ...
        try {
            var t = Qt.lex(e, n);
            return n.walkTokens && gn.walkTokens(t, n.walkTokens),
            ln.parse(t, n)
        } catch (e) {
            if (e.message += "\nPlease report this to https://github.com/markedjs/marked.",
            n.silent)
                return "<p>An error occurred:</p><pre>" + pn(e.message + "", !0) + "</pre>";
            throw e
        }
    }
    gn.options = gn.setOptions = function(e) {
        return cn(gn.defaults, e),
        fn(gn.defaults),
        gn
    }
    ,
        ...
        if (a.tokenizer) {
            function r(e) {
                ...
                i[s] = function() {
                    ...
                    return !1 === n && (n = r.apply(i, e)),
                    n
                }
            }
            var i = gn.defaults.tokenizer || new Ht;
            for (var s in a.tokenizer)
                r();
            e.tokenizer = i
        }
        if (a.walkTokens) {
    ...
    var mn = gn.parse = gn;
    function vn(e, t) {
        if (void 0 === t && (t = '<ul class="app-sub-sidebar">{inner}</ul>'),
        !e || !e.length)
            return "";
        var n = "";
        return e.forEach(function(e) {
            n += '<li><a class="section-link" href="' + e.slug + '" title="' + e.title + '">' + e.title + "</a></li>",
    ...
    function _n(e) {
        if ("string" != typeof e)
            return "";
        var t = e.trim().replace(/[A-Z]+/g, wn).replace(/<[^>\d]+>/g, "").replace(xn, "").replace(/\s/g, "-").replace(/-+/g, "-").replace(/^(\d)/, "_$1")
          , n = kn[t];
        return n = l.call(kn, t) ? n + 1 : 0,
        (kn[t] = n) && (t = t + "-" + n),
        t
    }
    function Sn(e, t) {
    ...
    var Tn, En = at(function(e) {
        var a = function(c) {
            var u = /\blang(?:uage)?-([\w-]+)\b/i
              ...
              , z = {
                    ...
                    DFS: function e(t, n, r, i) {
                        ...
                        for (var o in t)
                            if (t.hasOwnProperty(o)) {
                                ...
                                var s = t[o]
                                  , l = z.util.type(s);
                                "Object" !== l || i[a(s)] ? "Array" !== l || i[a(s)] || (i[a(s)] = !0,
                                e(s, n, o, i)) : (i[a(s)] = !0,
                                e(s, n, null, i))
                            }
                    }
                ...
                highlightElement: function(e, t, n) {
                    ...
                    if (z.hooks.run("before-sanity-check", o),
                    !o.code)
                        return z.hooks.run("complete", o),
                        void (n && n.call(o.element));
                    if (z.hooks.run("before-highlight", o),
                    o.grammar)
                        if (t && c.Worker) {
                            ...
                            s(z.highlight(o.code, o.grammar, o.language));
                    else
                        s(z.util.encode(o.code))
                },
                highlight: function(e, t, n) {
                    ...
                    return z.hooks.run("before-tokenize", r),
                        ...
                        for (var s in r)
                            if (r.hasOwnProperty(s) && r[s]) {
                                ...
                                for (var c = 0; c < l.length; ++c) {
                                    ...
                                    for (var v = u.pattern || u, b = i.next, y = a; b !== n.tail && !(o && y >= o.reach); y += b.value.length,
                                    b = b.next) {
                                        var k = b.value;
                                        ...
                                        if (!(k instanceof O)) {
                                            ...
                                            if (f && b != n.tail.prev) {
                                                ...
                                                b.value instanceof O)
                                                    continue;
                                                for (var T = b; T !== n.tail && (A < S || "string" == typeof T.value); T = T.next)
                                                    x++,
                                                    A += T.value.length;
                                                x--,
                                                k = t.slice(y, A),
            ...
            ,
            !c.document)
                return c.addEventListener && (z.disableWorkerMessageHandler || c.addEventListener("message", function(e) {
        ...
        function() {
            if ("undefined" != typeof self && self.Prism && self.document) {
                var l = window.Prism
                  ...
                  , u = "data-src-status"
                  , p = "loading"
                  , d = "pre[data-src]:not([" + u + '="loaded"]):not([' + u + '="' + p + '"])'
                  , r = /\blang(?:uage)?-([\w-]+)\b/i;
                ...
                l.hooks.add("before-sanity-check", function(e) {
                    ...
                    if (t.matches(d)) {
                        ...
                        s.onreadystatechange = function() {
                            4 == s.readyState && (s.status < 400 && s.responseText ? (t.setAttribute(u, "loaded"),
                            n.textContent = s.responseText,
                            l.highlightElement(n)) : (t.setAttribute(u, "failed"),
                            400 <= s.status ? n.textContent = function(e, t) {
                                return "✖ Error " + e + " while fetching file: " + t
                            }(s.status, s.statusText) : n.textContent = "✖ Error: File does not exist or is empty"))
                        }
                        ,
                        s.send(null)
                    }
                ...
                var e = !(l.plugins.fileHighlight = {
                    highlight: function(e) {
                        for (var t, n = (e || document).querySelectorAll(d), r = 0; t = n[r++]; )
                            ...
                            if ("string" == typeof r || r.content && "string" == typeof r.content) {
                                ...
                                if (-1 < l) {
                                    ...
                                    var c = o.substring(0, l)
                                      , u = new Tn.Token(h,Tn.tokenize(a, f.grammar),"language-" + h,a)
                                      , p = o.substring(l + s.length)
                                      , d = [];
                                    c && d.push.apply(d, e([c])),
                                    d.push(u),
                                    p && d.push.apply(d, e([p])),
                                    "string" == typeof r ? t.splice.apply(t, [n, 1].concat(d)) : r.content = d
                                }
                            } else
    ...
    var Rn = {}
      ...
      , $n = function(i, e) {
        ...
        var n = i.markdown || {};
        o = r(n) ? n(mn, t) : (mn.setOptions(f(n, {
            renderer: f(t, n.renderer)
        })),
        mn),
        this._marked = o,
            ...
            var r = !0
              , e = s(function(e) {
                ...
                t = i.noEmoji ? t : function(e) {
                    ...
                    }).replace(/:(\w+?):/gi, window.emojify || Sn).replace(/__colon__/g, ":")
                }(t),
                _n.clear(),
                t) : n
            })(n)
    ...
    $n.prototype.compileEmbed = function(e, t) {
        var n, r = An(t), i = r.str, a = r.config;
        if (t = i,
        a.include) {
            var o;
            if (Q(e) || (e = re(this.contentBase, ee(this.router.getCurrentPath()), e)),
            a.type && (o = Cn[a.type]))
                (n = o.call(this, e, t)).type = a.type;
            else {
                var s = "code";
                /\.(md|markdown)/.test(e) ? s = "markdown" : /\.mmd/.test(e) ? s = "mermaid" : /\.html?/.test(e) ? s = "iframe" : /\.(mp4|ogg)/.test(e) ? s = "video" : /\.mp3/.test(e) && (s = "audio"),
                (n = Cn[s].call(this, e, t)).type = s
            }
            return n.fragment = a.fragment,
            n
        }
    }
    ,
    $n.prototype._matchNotCompileLink = function(e) {
        for (var t = this.config.noCompileLinks || [], n = 0; n < t.length; n++) {
            var r = t[n];
            if ((Rn[r] || (Rn[r] = new RegExp("^" + r + "$"))).test(e))
                return e
        }
    }
    ,
    $n.prototype._initRenderer = function() {
        ...
        return i.heading = e.heading = function(e, t) {
            ...
            return a.slug = s,
            c.toc.push(a),
            "<h" + t + ' id="' + o + '"><a href="' + s + '" data-id="' + o + '" class="anchor"><span>' + r + "</span></a></h" + t + ">"
        }
        ,
        i.code = function(e) {
            return e.renderer.code = function(e, t) {
                ...
                return '<pre v-pre data-lang="' + t + '"><code class="lang-' + t + '">' + En.highlight(e.replace(/@DOCSIFY_QM@/g, "`"), n) + "</code></pre>"
            }
        }({
            renderer: e
        }),
        i.link = function(e) {
            ...
            return t.link = function(e, t, n) {
                ...
                var r = []
                  ...
                  , o = i.config;
                return l = o.target || l,
                c = "_blank" === l ? u.config.externalLinkRel || "noopener" : "",
                t = a,
                Q(e) || u._matchNotCompileLink(e) || o.ignore ? (!Q(e) && e.startsWith("./") && (e = document.URL.replace(/\/(?!.*\/).*/, "/").replace("#/./", "") + e),
                r.push(0 === e.indexOf("mailto:") ? "" : 'target="' + l + '"'),
                r.push(0 === e.indexOf("mailto:") ? "" : "" !== c ? ' rel="' + c + '"' : "")) : (e === u.config.homepage && (e = "README"),
                e = s.toURL(e, null, s.getCurrentPath())),
                o.crossorgin && "_self" === l && "history" === u.config.routerMode && -1 === u.config.crossOriginLinks.indexOf(e) && u.config.crossOriginLinks.push(e),
                o.disabled && (r.push("disabled"),
                e = "javascript:void(0)"),
        ...
        i.paragraph = function(e) {
            return e.renderer.paragraph = function(e) {
                return /^!&gt;/.test(e) ? bn("tip", e) : /^\?&gt;/.test(e) ? bn("warn", e) : "<p>" + e + "</p>"
            }
        }({
            renderer: e
        }),
        i.image = function(e) {
            ...
            return t.image = function(e, t, n) {
                ...
                return s.class && i.push('class="' + s.class + '"'),
                s.id && i.push('id="' + s.id + '"'),
    ...
    function On(e, i) {
        ...
        var d = [];
        !function(e, o) {
            var t, n = e.embedTokens, s = e.compile, l = (e.fetch,
            0), c = 1;
            if (!n.length)
                return o({});
            for (; t = n[l++]; ) {
    ...
    function Pn(e) {
        ...
        !1 === this.config.executeScript || void 0 === window.Vue || Mn() ? this.config.executeScript && Mn() : setTimeout(function(e) {
    ...
    function Dn(e) {
        ...
        if (i) {
            ...
            a += function(e) {
                var t = e.name ? e.name : "";
                return "<main>" + ('<button class="sidebar-toggle" aria-label="Menu"><div class="sidebar-toggle-button"><span></span><span></span><span></span></div></button><aside class="sidebar">' + (e.name ? '<h1 class="app-name"><a class="app-name-link" data-nosearch>' + (e.logo ? '<img alt="' + t + '" src=' + e.logo + ">" : t) + "</a></h1>" : "") + '<div class="sidebar-nav">\x3c!--sidebar--\x3e</div></aside>') + '<section class="content"><article class="markdown-section" id="main">\x3c!--main--\x3e</article></section></main>'
            }(t),
            e._renderTo(i, a, !0)
        } else
            e.rendered = !0;
        t.mergeNavbar && h ? o = b(".sidebar") : (r.classList.add("app-nav"),
        t.repo || r.classList.add("no-badge")),
        t.loadNavbar && k(o, r),
        t.themeColor && (u.head.appendChild(g("div", function(e) {
            return "<style>:root{--theme-color: " + e + ";}</style>"
        }(t.themeColor)).firstElementChild),
        function(n) {
    ...
    Hn.prototype.getFile = function(e, t) {
        ...
        return e = (e = function(e, t) {
            ...
            var i = Object.keys(n).filter(function(e) {
                return (jn[e] || (jn[e] = new RegExp("^" + e + "$"))).test(t) && t !== r
            })[0];
            return i ? e(t.replace(jn[i], n[i]), n, t) : t
        }(e, n.alias) : e, i)) === "/README" + i && n.homepage || e,
        e = Q(e) ? e : re(r, e),
        ...
        e.prototype.onchange = function(r) {
            ...
            x("click", function(e) {
                ...
                if ("A" === t.tagName && !/_blank/.test(t.target)) {
                    e.preventDefault();
                    var n = t.href;
                    -1 !== i.config.crossOriginLinks.indexOf(n) ? window.open(n, "_self") : window.history.pushState({
                        key: n
                    }, "", n),
                    r({
                        event: e,
    ...
    function Yn(t, n, r, i, a, e) {
        t = e ? t : t.replace(/\/$/, ""),
        (t = ee(t)) && q(a.router.getFile(t + r) + n, !1, a.config.requestHeaders).then(i, function(e) {
            return Yn(t, n, r, i, a)
        })
    }
    ...
    Jn._init = function() {
        ...
        function(t) {
            var e, n = t.config;
            e = "history" === (n.routerMode || "hash") && i ? new Un(n) : new qn(n),
            t.router = e,
            Zn(t),
            Bn = t.route,
            e.onchange(function(e) {
                Zn(t),
                t._updateRender(),
                Bn.path !== t.route.path ? (t.$fetch(p, t.$resetEvents.bind(t, e.source)),
                Bn = t.route) : t.$resetEvents(e.source)
            })
        }(e),
        Dn(e),
        Wn(e),
    ...
    Xn._renderSidebar = function(e) {
        var t = this.config
          ...
          , i = t.loadSidebar;
        if (t.hideSidebar)
            return document.querySelector("aside.sidebar").remove(),
    ...
    Xn._renderCover = function(e, t) {
        var n = m(".cover");
        if (_(m("main"), t ? "add" : "remove", "hidden"),
        e) {
            _(n, "add", "show");
    ...
    Kn._fetchFallbackPage = function(n, r, i) {
        ...
        return er(c + r, 0, t).then(function(e, t) {
    ...
    Kn._fetch404 = function(e, t, n) {
        ...
        if (s) {
            var c = function(t, e) {
                var n, r, i = e.notFoundPage, a = "_404" + (e.ext || ".md");
                switch (typeof i) {
                case "boolean":
                    r = a;
                    break;
            ...
            return er(this.router.getFile(c), 0, o).then(function(e, t) {
        ...
        return this._renderMain(null, {}, l),
        !1
    }
    ,
    Jn.$resetEvents = function(e) {
        ...
        "history" !== e && (t.route.query.id && be(t.route.path, t.route.query.id),
        "navigate" === e && n && function(e) {
            void 0 === e && (e = 0),
            ye.scrollTop = !0 === e ? 0 : Number(e)
        }(n)),
        this.config.loadNavbar && Y(this.router, "nav")
    }
    ,
